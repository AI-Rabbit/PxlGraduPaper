...
\begin{figure}[htb]
	...
	\hfil
	\subfloat[正视实物图]{\includegraphics[width=0.3\linewidth]{Figures/28-GHz-RIS-real.jpg}}
	\hfil
	\subfloat[立体实物图]{\includegraphics[width=0.3\linewidth]{Figures/28-GHz-RIS-real2.jpg}}
	\caption{28 GHz智能超表面}
