...
同理，由\autoref{eq:Generalized-snell-law}也可以推到出广义斯涅尔反射定律。对于反射的情况，入射波和反射波都在介质1中，所以有$n_2=n_1$，可得：
\begin{equation}
...
\end{eqnarray}
其中$k_{x}^{(i, r, t)}=k_{\mathrm{o}} n_{i, i, t} \sin \theta_{i, r, t}$表示平面波矢量。当$\frac{d \Phi}{d x}=0$时，即得到经典的斯涅尔定律。
