...
在本章中，我们首先在第二节解释了无源金属表面如何散射入射波，然后在第三节推导出智能超表面必须如何设计来模拟这种表面，同时控制散射波的方向性，总结了一个严格的路径损耗模型。
...
\begin{figure}[htb]
	...
	\hfil
	\subfloat[实物图]{\includegraphics[width=0.4\linewidth]{Figures/CCB_3D.pdf}}
	\caption{智能超表面控制电路}
	\label{fig:CCB_ALL}
\end{figure}
...
\autoref{fig:Timing-diagram}为74LVC595ABQ的时序图。
...
毕业设计主要内容到这里就告一段落了，下面总结一下这几个月来的研究工作和未来研究生阶段的展望
