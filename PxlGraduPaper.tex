...
控制电路的原理图详见附录~\ref{sec:schdoc}，\autoref{fig:CCB_3D}为其三维仿真图。

\begin{generalfig}[htb]{控制电路三维图}{fig:CCB_3D}
	\includegraphics[width=0.8\linewidth]{Figures/CCB_3D.pdf}
\end{generalfig}
...
考虑到底层的控制逻辑需要并行输出，顶层又需要做算法的执行和无线通信，所以选择了
